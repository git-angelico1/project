                ...
                <div class="col-xs-12 col-sm-12 col-md-4 mx-auto">
                    <div class="row mt-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-15">
                            <div class="form-group">
                                <strong>
                                    Debtors Date of Transaction
                                </strong>
                                <input class="form-control" name="date_of_transaction" type="text" value="{{ $debtors->date_of_transaction }}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>
                                    Debtors Amount Borrowed
                                </strong>
                                <input class="form-control" name="amount_borrowed" type="text" value="{{ $debtors->amount_borrowed }}">
